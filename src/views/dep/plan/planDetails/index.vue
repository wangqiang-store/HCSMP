      ...
      <el-row>
        ...
        >
          ...
          <div>
            <el-button
              type="primary"
              v-show="sessionRead('planDetails').showBtnList.includes('edit')"
              class="button"
              @click="handleEdit"
      ...
      >
        ...
        >
          ...
          >
            ...
            <div class="el-upload__tip">只能上传docx/pdf格式文件, 并且只能上传一份</div>
          </el-form-item>
        </el-form>
        <template #footer>
...
import { RES_SUCCESS, sessionWrite, sessionRead } from '@/api/common/common';
import { updateYearFile } from '@/api/dep/plan';
...
export default defineComponent({
  ...
  setup(props) {
    ...
    let METHODS = reactive({
      ...
      handleGetData: () => {
        //获取页面参数
        DATA.pageData = sessionRead('planDetails');
      },
